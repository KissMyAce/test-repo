        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:block">
              ...
              <p className="text-primary-foreground font-semibold text-sm leading-tight">{userName}</p>
            </div>
          </div>
        </div>

        <div className="flex items-center gap-2">
          <Link to="/notifications" className="relative p-2 text-primary-foreground/80 hover:text-primary-foreground transition-colors">
      ...
      <div className="flex flex-1">
        ...
        <aside className="hidden lg:flex flex-col w-60 bg-card border-r border-border p-4 gap-1">
          <div className="flex items-center gap-2 px-3 mb-6">
            ...
            <span className="font-bold text-foreground">Jee-PS</span>
          </div>
